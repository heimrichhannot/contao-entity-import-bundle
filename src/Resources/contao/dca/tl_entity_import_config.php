...
//    'onload_callback'  => [[\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'initPalette', true]],
...
//            'child_record_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'listEntityImportConfig', true],
...
//            'label_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'addDate', true],
//        ],
//        'global_operations' => [
//            'all' => [
...
//    // type palettes
//    'typepalettes' => [
//        \HeimrichHannot\EntityImportBundle\DataContainer\EntityImportContainer::TYPE_DATABASE => '{config_legend},dbSourceTable,dbTargetTable,importerClass,purgeBeforeImport,addMerge,dbFieldMapping,useTimeInterval,whereClause,sourceDir,targetDir,dbFieldFileMapping;',
//        \HeimrichHannot\EntityImportBundle\DataContainer\EntityImportContainer::TYPE_FILE     => '{config_legend},sourceFile,delimiter,enclosure,arrayDelimiter,dbTargetTable,importerClass,purgeBeforeImport,addMerge,fileFieldMapping,sourceDir,targetDir;',
//    ],
//    // Fields
//    'fields'       => [
//        'id'                      => [
...
//            'inputType'        => 'select',
//            'eval'             => ['mandatory' => true, 'submitOnChange' => true, 'tl_class' => 'w50', 'chosen' => true],
//            'options_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'getTargetTables', true],
//            'sql'              => "varchar(255) NOT NULL default ''",
//        ],
//        'importerClass'           => [
...
//            'options_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'getImporterClasses', true],
//            'sql'              => "varchar(255) NOT NULL default ''",
//        ],
//        'purgeBeforeImport'       => [
...
//                            'inputType'        => 'select',
//                            'options_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'getSourceFields', true],
//                            'eval'             => [
...
//                            'inputType'        => 'select',
//                            'options_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'getTargetFields', true],
//                            'eval'             => [
...
//                            'label'            => &$GLOBALS['TL_LANG']['tl_entity_import_config']['dbFieldMapping']['target'],
//                            'inputType'        => 'select',
//                            'options_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'getMergeTargetFields', true],
//                            'eval'             => [
...
//                            'label'            => &$GLOBALS['TL_LANG']['tl_entity_import_config']['dbFieldMapping']['target'],
//                            'inputType'        => 'select',
//                            'options_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'getTargetFileFields', true],
//                            'eval'             => [
//                                'chosen'     => true,
//                                'groupStyle' => 'width:150px',
//                            ],
...
//            'options_callback' => [\HeimrichHannot\EntityImportBundle\DataContainer\EntityImportConfigContainer::class, 'getTypoCategories', true],
//            'sql'              => "blob NULL",
//        ],
//        'catContao'               => [
